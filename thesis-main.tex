...
La tesi ha come obiettivo la progettazione e l'implementazione di un prototipo di simulatore reattivo basato sul simulatore Alchemist, ovvero un simulatore ad eventi discreto che utilizzi tecniche di programmazione reattiva, eliminando la necessità di un grafo per la gestione delle dipendenze fra eventi, attualmente presente in Alchemist. 
\end{abstract}
